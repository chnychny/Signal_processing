...
Figsavedir = datapath+'figure_IPM109timevaring\\'
Figsavedir2 = datapath+'Img_IPM109timevaring\\'
Figsavedir3 = datapath+'Img_IPM109timevaring_combine\\'
...
for cond_name in folder_list: # 상태
    for file_name in os.listdir(datadir+cond_name):
        ...
        log_df = log_df.iloc[list(range(Tick_time[0],Tick_time[1],1)),:]
